...
from .const import CONF_ADD_LEDS, CONF_ADD_ZONES, CONFIG_VERSION, CONN_TIMEOUT, DEFAULT_ADD_LEDS, DEFAULT_ADD_ZONES, DEFAULT_CLIENT_ID, DEFAULT_PORT, DOMAIN
...
class OpenRGBOptionsFlowHandler(config_entries.OptionsFlow):
    ...
    def __init__(self, config_entry):
        ...
        self._add_zones = config_entry.data[CONF_ADD_ZONES] if CONF_ADD_ZONES in config_entry.data else DEFAULT_ADD_ZONES
